...
import org.bonej.pqct.analysis.ConcentricRingAnalysis;
import org.bonej.pqct.analysis.CorticalAnalysis;
import org.bonej.pqct.analysis.DetermineAlfa;
import org.bonej.pqct.analysis.DistributionAnalysis;
import org.bonej.pqct.analysis.MassDistribution;
import org.bonej.pqct.analysis.SoftTissueAnalysis;
import org.bonej.pqct.io.ImageAndAnalysisDetails;
import org.bonej.pqct.io.ScaledImageData;
import org.bonej.pqct.selectroi.RoiSelector;
import org.bonej.pqct.selectroi.SelectROI;
import org.bonej.pqct.selectroi.SelectSoftROI;
import org.bonej.pqct.utils.ResultsImage;
import org.bonej.pqct.utils.ResultsWriter;
		...
		if (getInfoProperty(imageInfo, "Stratec File") == null) {
			...
			try {
				final InputStream ir = this.getClass().getClassLoader()
						.getResourceAsStream("org/bonej/bonej/pqct/typ/" + typFileName);
