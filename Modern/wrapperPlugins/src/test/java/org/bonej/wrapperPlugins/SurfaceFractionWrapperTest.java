...
public class SurfaceFractionWrapperTest {
	...
	public void testResults() throws Exception {
		...
		final double expectedVolume = Math.sqrt(0.5) * Math.sqrt(0.5) * 0.5 / 3.0 *
			2.0;
		final String unit = "mm";
		final double[][] expectedValues = { { 0.0, 0.0, expectedVolume, 0.0 }, {
			0.0, expectedVolume, expectedVolume, 1.0 }, { 0.0, expectedVolume,
				expectedVolume, 1.0 }, { 0.0, 0.0, expectedVolume, 0.0 } };
