...
public class CreateEFTestImage extends ContextCommand {
    @Parameter
    double shortestEllipsoidDimension = 10;
    ...
    public void run() {
        //create image
        final ArrayImg testImage = ArrayImgs.unsignedBytes(200, 200, 200);
        ...
        {
            final int x = rng.nextInt(199);
            final int y = rng.nextInt(199);
            final int z = rng.nextInt(199);
            ...
            while(localizingCursor.hasNext())
            {
                ...
                //sphere
                if(xc2+yc2+zc2 <= 16*r2)
                {
                    localizingCursor.get().set(255);
                }
                //rod
                else if(xc2/(100*r2)+yc2/r2+zc2/r2 <= 1)
                {
                    localizingCursor.get().set(255);
                }
                //plate
                else if(xc2/r2+yc2/(100*r2)+zc2/(100*r2) <= 1)
                {
                    localizingCursor.get().set(255);
                }
            }
