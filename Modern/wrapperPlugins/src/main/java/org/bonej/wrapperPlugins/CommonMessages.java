...
public final class CommonMessages {
	...
	static final String HAS_TIME_DIMENSIONS =
		"Image cannot have time axis";
	static final String HAS_CHANNEL_DIMENSIONS =
		"Image cannot be composite";
	static final String NOT_BINARY = "Need a binary image";
	static final String NOT_8_BIT_BINARY_IMAGE =
	...
	static final String BAD_CALIBRATION =
