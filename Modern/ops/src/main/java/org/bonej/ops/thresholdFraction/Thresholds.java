...
/**
 * A helper class to pass threshold values as a single input. The thresholds fit
 * a certain type of image.
 *
 * @author Richard Domander
 */
// TODO Remove thresholdFraction package, and do with threshold ops from imagej-ops
public final class Thresholds<T extends RealType<T> & NativeType<T>> {
	 ...
	 */
	public Thresholds(final RandomAccessible<T> interval, final double min,
		final double max)
	{
